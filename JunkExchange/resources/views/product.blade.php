...
@include('partials.hypernav')
    ...
    <div class="d-grid gap-2">
        <button type="button" class="btn my-4" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="border-color: #2ABA86; color: #2ABA86" >
        Isi Form Pengajuan
        </button>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel"> <strong>Form Pengajuan</strong></h1>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn text-white" style="background-color: #2ABA86">Simpan</button>
        </div>
        </div>
    </div>
    </div>
